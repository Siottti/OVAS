			...
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
						...
						$qry = $conn->query("SELECT u.*,concat(u.firstname,' ',u.lastname) as name, c.clinicname as clinic from `users` u left join clinic c on c.id = u.clinic_id  where u.id != '1' $whereClinic order by concat(u.firstname,' ',u.lastname) asc ");
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo $row["clinic"] ?? "Main" ?></p></td>
							<td align="center">
